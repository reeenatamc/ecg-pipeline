...
|---|---|---|
| **`rhythm`** (por defecto) | checkpoint de 1 derivación sobre la(s) tira(s) preferida(s) que llegan a longitud completa (II/V5; si ninguna se imprimió, usa cualquier otra tira convencional -- II/V1/V5 según AHA/ACCF/HRS 2007 -- o derivación disponible; ver `configs/thresholds/README.md`), promediando opiniones | **ritmo y frecuencia**. Es el fiable |
