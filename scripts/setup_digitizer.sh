...
# In filename order, because each patch is a diff against the tree the previous ones
# left behind: applying 0002 to an unpatched checkout is not the same file.
